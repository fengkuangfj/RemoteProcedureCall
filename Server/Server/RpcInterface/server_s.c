...
RPC_IF_HANDLE RpcServerInterface_v1_0_s_ifspec = (RPC_IF_HANDLE)& RpcServerInterface___RpcServerInterface;
    ...
    /* [string][in] */ unsigned char *pch)
{
    ...
    _RetVal = NdrClientCall2(
                  ...
                  (PFORMAT_STRING) &Server__MIDL_ProcFormatString.Format[96],
                  ( unsigned char * )&pch);
...
static const MIDL_STUB_DESC RpcServerInterface_StubDesc = 
    {
    (void *)& RpcServerInterface___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
